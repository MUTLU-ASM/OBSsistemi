...
{
    public partial class OgrenciGirisSayfası : System.Web.UI.Page
    {
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Select * From Tbl_Ogrenci where eposta=@p1 and sifre=@p2", baglanti);
            ...
            {   
                ...
                Response.Redirect("https://localhost:44350/OgrenciAnasayfa.aspx");
